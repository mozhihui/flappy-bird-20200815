...
var bird = {
    ...
    judgePipe : function(){
        var index = this.score % this.pipeLength;
        var pipeX = this.pipeArr[index].up.offsetLeft;
        var pipeY = this.pipeArr[index].y;      /* 安全区域数组 */
    ...
    createPipe : function(x){
        // Math.random( )  0-1             50  -  225
        // 上下距离相等 150  ,即柱子：(600 - 150) / 2 = 225,
    ...
    startBound : function(){
        var pervColor = this.startColor;
        this.startColor = this.startColor ===  'blue' ? 'white' : 'blue' ;
        this.oStart.classList.remove('start-' + pervColor);
